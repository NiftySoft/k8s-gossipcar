...
public class GossipServerHandlerTest {
  ...
  public void testGossipServerHandlerSwitchesToSyncHandlersAndSetsEncoderAndDecoder() {
    ...
    assertThat(chan.pipeline().get("encoder"))
        .hasSameClassAs(new VolatileStringStore.VolatileStringStoreEncoder());
    assertThat(chan.pipeline().get("decoder"))
        .hasSameClassAs(new VolatileStringStore.VolatileStringStoreDecoder());
  }
